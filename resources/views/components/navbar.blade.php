                                ...
                                <div class="select-items">
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td class="si-pic"><img
                                                        src="{{ asset('assets/img/select-product-1.jpg') }}"
                                                        alt=""></td>
                                                <td class="si-text">
                                            ...
                                            <tr>
                                                <td class="si-pic"><img
                                                        src="{{ asset('assets/img/select-product-2.jpg') }}"
                                                        alt=""></td>
                                                <td class="si-text">
                                                    <div class="product-selected">
                                                        <p>$60.00 x 1</p>
    ...
    <div class="nav-item">
        <div class="container">
            ...
            <nav class="nav-menu mobile-menu">
                <ul>
                    <li class="@if ($menuName == 'home') active @endif">
                        <a href="{{ route('page.home') }}">Home</a>
                    </li>
                    <li class="@if ($menuName == 'shop') active @endif">
                    ...
                    <li class="@if($menuName == 'blog') active @endif">
                    ...
                    <li>
                        <a href="#">Pages</a>
                        <ul class="dropdown">
                            <li><a href="{{ route('blog.detailes') }}">Blog Details</a></li>
